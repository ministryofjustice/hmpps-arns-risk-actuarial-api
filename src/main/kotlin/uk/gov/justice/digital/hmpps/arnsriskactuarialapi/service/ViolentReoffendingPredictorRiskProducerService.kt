...
@Service
class ViolentReoffendingPredictorRiskProducerService(val validator: ViolentReoffendingPredictorValidator, val offenceCodeCacheService: OffenceCodeCacheService) : BaseRiskScoreProducer() {
