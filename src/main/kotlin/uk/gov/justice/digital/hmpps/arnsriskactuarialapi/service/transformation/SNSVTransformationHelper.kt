...
class SNSVTransformationHelper {
  companion object {
    ...
    fun getViolentSanctionsWeight(
      ...
      when {
        totalNumberOfViolentSanctions == 0 -> weightsPair.second[gender]!!
        totalNumberOfViolentSanctions == 1 -> weightsPair.first[0]
        totalNumberOfViolentSanctions > 1 -> weightsPair.first[1]
