...
import uk.gov.justice.digital.hmpps.arnsriskactuarialapi.service.transformation.*
...
class OGRS3RiskScoreService {
  ...
  private fun getOGRS3Object(riskScoreRequest: RiskScoreRequestValidated): OGRS3Object =
    runCatching {
