...
enum class ValidationErrorType(val message: String) {
  ...
  DATE_OF_START_OF_FOLLOWUP_OUT_OF_RANGE("Age at date at start of followup must be more than 10 and less than 110"),
  DATE_OF_START_OF_FOLLOWUP_REQUIRED("Either Date at start of followup or date of current conviction must be provided"),
  DATE_OF_MOST_RECENT_SEXUAL_OFFENCE_OUT_OF_RANGE("Age at date at start of most recent sexual offence must be more than 10 and less than 110"),
