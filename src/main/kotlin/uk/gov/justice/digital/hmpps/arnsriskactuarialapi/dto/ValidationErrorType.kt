...
enum class ValidationErrorType(val message: String) {
  ...
  DRUG_MISUSE_REQUIRED("When hasCurrentDrugMisuse is true, motivationToTackleDrugMisuse cannot be null and drug usage questions cannot be null"),
  DRUG_MISUSE_INCONSISTENT("When hasCurrentDrugMisuse is false, motivationToTackleDrugMisuse must be null and all drug usage questions must be false or null"),
