...
enum class ValidationErrorType(val message: String) {
  ...
  DATE_OF_MOST_RECENT_SEXUAL_OFFENCE_BEFORE_DATE_OF_BIRTH("Date of most recent sexual offence cannot be before date of birth"),
  DATE_OF_START_OF_FOLLOWUP_OUT_OF_RANGE_UPPER("Age at date at start of followup must be less than 110"),
  DATE_OF_START_OF_FOLLOWUP_OUT_OF_RANGE_LOWER("Age at date at start of followup must be more than 18"),
  DATE_OF_MOST_RECENT_SEXUAL_OFFENCE_OUT_OF_RANGE("Age at date at start of followup must be more than 10"),
  ...
  SEXUAL_REOFFENDING_PREDICTOR_NO_SANCTIONS("If hasEverCommittedSexualOffence is true, at least one sexual sanction/offence must be more than 0"),
  TOTAL_NUMBER_OF_SEXUAL_SANCTIONS_OUT_OF_RANGE("Sexual sanctions count must be greater than 0, but less than or equal to total number of sanctions"),
