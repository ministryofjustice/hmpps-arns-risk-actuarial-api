  ...
  companion object {
    ...
    fun getCopasWeightProvider() = listOf(
      Arguments.of(
        ...
        20,
        30,
        BigDecimal("-1.0764458092822229405783122133808863513121586582379940466580592328682541847229003906250"),
      ),
      Arguments.of(
        StaticOrDynamic.STATIC,
        Gender.FEMALE,
        ...
        24,
        26,
        BigDecimal("-1.413747247115475100006875246847061544082812902808132804466367815621197223663330078125"),
      ),
      Arguments.of(
        StaticOrDynamic.DYNAMIC,
        Gender.MALE,
        ...
        18,
        42,
        BigDecimal("-2.86765151836398441188439059500396862198870472567691081167140509933233261108398437500"),
      ),
      Arguments.of(
        StaticOrDynamic.DYNAMIC,
        Gender.FEMALE,
        ...
        21,
        25,
        BigDecimal("-1.33575518316174319991457394070182516071067042935149871141220501158386468887329101562500"),
      ),
    )
    ...
    fun getCopasSquaredWeightProvider() = listOf(
      Arguments.of(
        ...
        20,
        30,
        BigDecimal("0.06213937529875994059358765546900857310267708783750418190533307718278339970537142646689332536880101542919874191284179687500"),
      ),
      Arguments.of(
        StaticOrDynamic.STATIC,
        Gender.FEMALE,
        ...
        24,
        26,
        BigDecimal("-0.075794724339568204360965064994604986454713937501057837610053526693845670867252891512999557477314738207496702671051025390625"),
      ),
      Arguments.of(
        StaticOrDynamic.DYNAMIC,
        Gender.MALE,
        ...
        18,
        42,
        BigDecimal("0.42515616770311846532132622658318255572733895186341640360422753469221499795215850769913856765924720093607902526855468750000"),
      ),
      Arguments.of(
        StaticOrDynamic.DYNAMIC,
        Gender.FEMALE,
        ...
        21,
        25,
        BigDecimal("-0.111387177854197828953233770299262287468305777559805056293324651521603430969321965826601683602348202839493751525878906250000"),
      ),
    )
