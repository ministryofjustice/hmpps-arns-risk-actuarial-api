  ...
  companion object {
    ...
    fun getCopasVWeightProvider() = listOf(
      Arguments.of(
        ...
        20,
        30,
        BigDecimal("-0.124535911906912207633405552237523198932398315611502770394736216985620558261871337890625"),
      ),
      Arguments.of(
        StaticOrDynamic.STATIC,
        Gender.FEMALE,
        ...
        24,
        26,
        BigDecimal("-0.352015821010451931836478533548343695041766529027715826316580205457285046577453613281250"),
      ),
      Arguments.of(
        StaticOrDynamic.DYNAMIC,
        Gender.MALE,
        ...
        18,
        42,
        BigDecimal("-1.18297910202262650564983739639376910051455700821299021896493286476470530033111572265625"),
      ),
      Arguments.of(
        StaticOrDynamic.DYNAMIC,
        Gender.FEMALE,
        ...
        21,
        25,
        BigDecimal("-0.4682952392033705902102905794483151291993719386166361573486938141286373138427734375000"),
      ),
    )
    ...
    fun getCopasViolentOffencesWeightProvider() = listOf(
      ...
      Arguments.of(
        ...
        20,
        30,
        BigDecimal("-0.41703875913010355854573112104990549773551364602428570549363939790055155754089355468750"),
      ),
      Arguments.of(
        StaticOrDynamic.DYNAMIC,
        5,
        18,
        42,
        BigDecimal("-0.992361394166722208117789741038349873570603390912858721151224017376080155372619628906250"),
      ),
    )
